...
use crate::msg::{DistanceResponse, InstantiateMsg, ExecuteMsg, QueryMsg, ScoreResponse, MigrateMsg};
...
pub fn instantiate(
  ...
  msg: InstantiateMsg,
    ...
    Ok(Response::new()
        ...
        .add_attribute("distance", msg.distance.to_string())
...
fn query_distance(deps:Deps) -> StdResult<DistanceResponse> {
    let state = STORAGE.load(deps.storage)?;
    Ok(DistanceResponse {distance: state.distance})
}
